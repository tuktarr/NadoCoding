...
int main_m_array_project(void) {
	...
	while (1) {
		...
		// ´Ù¸¥ µ¿¹°ÀÎ °æ¿ì
			...
			printf("\n\n ¶¯!! (Æ²·È°Å³ª, ÀÌ¹Ì µÚÁýÈù Ä«µåÀÔ´Ï´Ù.\n");
		...
		//¸ðµç µ¿¹°À» Ã£¾Ò´ÂÁö ¿©ºÎ, 1 : Âü, 0 : °ÅÁþ
		if (foundAllAnimals() == 1) {
			printf("\n\n ÃàÇÏÇÕ´Ï´Ù ! ¸ðµç µ¿¹°À» ´Ù Ã£¾Ò³×¿ä. \n");
			printf("Áö±Ý±îÁö ÃÑ %d¹ø ½Ç¼öÇÏ¼Ì½À´Ï´Ù.",failCount);
			break;
		}
